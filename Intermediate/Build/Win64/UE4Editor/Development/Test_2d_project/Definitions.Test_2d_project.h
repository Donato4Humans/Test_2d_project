#undef TEST_2D_PROJECT_API
#undef TEST_2D_PROJECT_VTABLE
...
#define UE_PROJECT_NAME Test_2d_project
...
#define TEST_2D_PROJECT_VTABLE DLLEXPORT_VTABLE
#define TEST_2D_PROJECT_API DLLEXPORT
